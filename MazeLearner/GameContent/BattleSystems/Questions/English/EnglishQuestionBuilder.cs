...
namespace MazeLearner.GameContent.BattleSystems.Questions.English
{
    public class EnglishQuestionBuilder
    {
        public static void Register()
        {
            ...
            EnglishQuestion.EnglishQuestions.Add(Question.Create("Which is a sentence fragment (not a complete sentence)?",
                new string[] { "The dog barked loudly", "When the bell rang", "I finished my work", "She smiles" }, 1));
            EnglishQuestion.EnglishQuestions.Add(Question.Create("Which sentence is correct?",
                new string[] { "She do her homework", "She does her homework", "She doing her homework", "She diding her homework" }, 1));
        }
    }
}
