...
namespace MazeLearner
{
    public class AssetsLoader
    {
        ...
        public static Assets<Texture2D> HeartLeft = Assets<Texture2D>.Request("UI/Entity/Heart_Left");
        public static Assets<Texture2D> Heart = Assets<Texture2D>.Request("UI/Entity/Heart");
        ...
        public static Assets<Texture2D> SelectionPlayer = Assets<Texture2D>.Request("UI/SelectionPlayer");
        public static Assets<Texture2D> BagMenu = Assets<Texture2D>.Request("UI/BagMenu");
        ...
        public static Assets<Texture2D> Box3 = Assets<Texture2D>.Request("UI/Box_3");
        public static Assets<Texture2D> Box4 = Assets<Texture2D>.Request("UI/Box_4");
        public static Assets<Texture2D> Arrow = Assets<Texture2D>.Request("UI/Arrow");
        public static Assets<Texture2D> MalePickBox = Assets<Texture2D>.Request("UI/MaleButton");
        public static Assets<Texture2D> FemalePickBox = Assets<Texture2D>.Request("UI/FemaleButton");
        ...
        public static Assets<Texture2D> Slider_0 = Assets<Texture2D>.Request("UI/Slider_0");
        public static Assets<Texture2D> Slider_0_Overlay = Assets<Texture2D>.Request("UI/Slider_0_Overlay");
    }
}
